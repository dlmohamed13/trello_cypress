...
//GET SPECIFIC BOARD
fetch('http://localhost:4000/api/boards/79800942081', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRsbW9oYW1lZDA3QGdtYWlsLmNvbSIsImlhdCI6MTYxOTg4NDk0NCwiZXhwIjoxNjE5ODg4NTQ0LCJzdWIiOiIxIn0.Fjyn9-Q2iFvJm8_TXP0mcATtOWFmebczM0pSi3oIA80',
  ...
  'referrer': 'http://localhost:4000/board/79800942081',
  'referrerPolicy': 'strict-origin-when-cross-origin',
  'body': null,
  'method': 'GET',
  'mode': 'cors'
...
//UPDATE BOARD 
fetch('http://localhost:4000/api/boards/12145775269', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
  ...
  'referrer': 'http://localhost:4000/board/12145775269',
  'referrerPolicy': 'strict-origin-when-cross-origin',
...
//Add Task Properties
fetch('http://localhost:4000/api/tasks/23307283956', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRsbW9oYW1lZDA3QGdtYWlsLmNvbSIsImlhdCI6MTYxOTg4NDk0NCwiZXhwIjoxNjE5ODg4NTQ0LCJzdWIiOiIxIn0.Fjyn9-Q2iFvJm8_TXP0mcATtOWFmebczM0pSi3oIA80',
...
//DELETE LIST 
fetch('http://localhost:4000/api/lists/41438957432', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IjEyMzRAZ21haWwuY29tIiwiaWF0IjoxNjE5ODg1MzkzLCJleHAiOjE2MTk4ODg5OTMsInN1YiI6IjMifQ.-V9M5oNYQHJO9rm4nwdD3UbZ-QPgC4IzS1-gOcfZUSA',
...
//DELETE TASK 
fetch('http://localhost:4000/api/tasks/66399248715', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IjEyMzRAZ21haWwuY29tIiwiaWF0IjoxNjE5ODg1MzkzLCJleHAiOjE2MTk4ODg5OTMsInN1YiI6IjMifQ.-V9M5oNYQHJO9rm4nwdD3UbZ-QPgC4IzS1-gOcfZUSA',
...
fetch('http://localhost:4000/api/users', {
  'headers': {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'en-US,en;q=0.9',
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IkRhcndpbjI1QGdtYWlsLmNvbSIsImlhdCI6MTYyMDAzNTYyNCwiZXhwIjoxNjIwMDM5MjI0LCJzdWIiOiI4In0.IcUym4ndkd5rkRqyAAG8rv3fNQsEzVXSC7pC5Z7lR-c',
    'if-none-match': 'W/"94-ErGJGvhuB29SU5+dTl9KwjBrq9g"',
    ...
    'sec-fetch-mode': 'cors',
    'sec-fetch-site': 'same-origin',
    'cookie': 'trello_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IkRhcndpbjI1QGdtYWlsLmNvbSIsImlhdCI6MTYyMDAzNTYyNCwiZXhwIjoxNjIwMDM5MjI0LCJzdWIiOiI4In0.IcUym4ndkd5rkRqyAAG8rv3fNQsEzVXSC7pC5Z7lR-c; io=vXDRFdu5cuTu0yFNAAvJ'
  },
  'referrer': 'http://localhost:4000/',
  'referrerPolicy': 'strict-origin-when-cross-origin',
  'body': null,
...
fetch('http://localhost:4000/signup', {
  'headers': {
    ...
    'sec-fetch-mode': 'cors',
    'sec-fetch-site': 'same-origin',
    'cookie': 'io=H0oE28xL8NJrDhnUAAvH'
  },
  'referrer': 'http://localhost:4000/',
  'referrerPolicy': 'strict-origin-when-cross-origin',
  'body': '{"email":"Darwin25@gmail.com","password":"password"}',
  'method': 'POST',
  'mode': 'cors'
});